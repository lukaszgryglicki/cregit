mkdir /home/justa/dev/k8s_memo 2>/dev/null
BFG_MEMO_DIR=/home/justa/dev/k8s_memo; export BFG_MEMO_DIR
...
sbt bfg/assembly
FILE=`find . -iname "*.jar"`
java -jar $FILE '--blob-exec:/home/justa/dev/cregit/tokenizeByBlobId/tokenBySha.pl=\.([ch]|go|md|sh|yml|yaml)$' --no-blob-protection /home/justa/dev/kubernetes
